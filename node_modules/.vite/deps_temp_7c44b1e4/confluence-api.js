...
// node_modules/confluence-api/lib/confluence.js
var require_confluence = __commonJS({
  "node_modules/confluence-api/lib/confluence.js"(exports, module) {
    var request = require_client();
    function Confluence(config) {
      if (!(this instanceof Confluence))
        return new Confluence(config);
      if (!config) {
    ...
    Confluence.prototype.getSpace = function(space, callback) {
      request.get(this.config.baseUrl + this.config.apiPath + "/space" + this.config.extension + "?spaceKey=" + space).auth(this.config.username, this.config.password).end(function(err, res) {
        processCallback(callback, err, res);
      });
    };
    Confluence.prototype.getSpaceHomePage = function(space, callback) {
      var config = this.config;
      request.get(config.baseUrl + config.apiPath + "/space" + config.extension + "?spaceKey=" + space).auth(config.username, config.password).end(function(err, res) {
        if (err) {
          callback(err);
        } else {
          try {
            request.get(config.baseUrl + res.body.results[0]._expandable.homepage).auth(config.username, config.password).end(function(err2, res2) {
              processCallback(callback, err2, res2);
            });
          } catch (e) {
    ...
    Confluence.prototype.getContentById = function(id, callback) {
      request.get(this.config.baseUrl + this.config.apiPath + "/content/" + id + this.config.extension + "?expand=body.storage,version").auth(this.config.username, this.config.password).end(function(err, res) {
        processCallback(callback, err, res);
      });
    };
    Confluence.prototype.getCustomContentById = function(options, callback) {
      var expanders = options.expanders || ["body.storage", "version"];
      request.get(this.config.baseUrl + this.config.apiPath + "/content/" + options.id + this.config.extension + "?expand=" + expanders.join()).auth(this.config.username, this.config.password).end(function(err, res) {
        processCallback(callback, err, res);
      });
    };
    Confluence.prototype.getContentByPageTitle = function(space, title, callback) {
      var query = "?spaceKey=" + space + "&title=" + title + "&expand=body.storage,version";
      request.get(this.config.baseUrl + this.config.apiPath + "/content" + this.config.extension + query).auth(this.config.username, this.config.password).end(function(err, res) {
        processCallback(callback, err, res);
      });
    };
    Confluence.prototype.postContent = function(space, title, content, parentId, callback, representation) {
      ...
      function createPage() {
        request.post(config.baseUrl + config.apiPath + "/content" + config.extension).auth(config.username, config.password).type("json").send(page).end(function(err, res) {
          processCallback(callback, err, res);
        });
      }
      if (!parentId) {
    ...
    Confluence.prototype.putContent = function(space, id, version, title, content, callback, minorEdit, representation) {
      ...
      request.put(this.config.baseUrl + this.config.apiPath + "/content/" + id + this.config.extension + "?expand=body.storage,version").auth(this.config.username, this.config.password).type("json").send(page).end(function(err, res) {
        processCallback(callback, err, res);
      });
    };
    Confluence.prototype.deleteContent = function(id, callback) {
      request.del(this.config.baseUrl + this.config.apiPath + "/content/" + id + this.config.extension).auth(this.config.username, this.config.password).end(function(err, res) {
        callback(err, res);
      });
    };
    Confluence.prototype.getAttachments = function(space, id, callback) {
      var query = "?spaceKey=" + space + "&expand=version,container";
      request.get(this.config.baseUrl + this.config.apiPath + "/content/" + id + "/child/attachment" + query).auth(this.config.username, this.config.password).end(function(err, res) {
        processCallback(callback, err, res);
      });
    };
    Confluence.prototype.createAttachment = function(space, id, filepath, callback) {
      request.post(this.config.baseUrl + this.config.apiPath + "/content/" + id + "/child/attachment").auth(this.config.username, this.config.password).set("X-Atlassian-Token", "nocheck").attach("file", filepath).end(function(err, res) {
        processCallback(callback, err, res);
      });
    };
    Confluence.prototype.updateAttachmentData = function(space, id, attachmentId, filepath, callback) {
      request.post(this.config.baseUrl + this.config.apiPath + "/content/" + id + "/child/attachment/" + attachmentId + "/data").auth(this.config.username, this.config.password).set("X-Atlassian-Token", "nocheck").attach("file", filepath).end(function(err, res) {
        processCallback(callback, err, res);
      });
    };
    Confluence.prototype.getLabels = function(id, callback) {
      request.get(this.config.baseUrl + this.config.apiPath + "/content/" + id + "/label").auth(this.config.username, this.config.password).end(function(err, res) {
        processCallback(callback, err, res);
      });
    };
    Confluence.prototype.postLabels = function(id, labels, callback) {
      request.post(this.config.baseUrl + this.config.apiPath + "/content/" + id + "/label").auth(this.config.username, this.config.password).type("json").send(labels).end(function(err, res) {
        processCallback(callback, err, res);
      });
    };
    Confluence.prototype.deleteLabel = function(id, label, callback) {
      request.del(this.config.baseUrl + this.config.apiPath + "/content/" + id + "/label?name=" + label).auth(this.config.username, this.config.password).end(function(err, res) {
        callback(err, res);
      });
    };
    Confluence.prototype.search = function(query, callback) {
      request.get(this.config.baseUrl + this.config.apiPath + "/search" + this.config.extension + "?" + query).auth(this.config.username, this.config.password).end(function(err, res) {
        processCallback(callback, err, res);
      });
    };
...
export default require_confluence();
